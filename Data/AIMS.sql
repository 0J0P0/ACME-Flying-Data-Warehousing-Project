...
CREATE TYPE SlotKind AS ENUM
('Flight', 'Maintenance', 'Buffer', 'Spare');
...
(
	...
	(
		...
		-- Date-Origin-Destination-FlightNumber-AircraftRegistration -> 6+1+3+1+3+1+4+1+6
